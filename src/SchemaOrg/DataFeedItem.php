...
class DataFeedItem extends Intangible implements \JsonSerializable
{
    ...
    {
        return array_merge(parent::jsonSerialize(), array_filter(array('dateModified' => $this->dateModified, 'dateCreated' => $this->dateCreated, 'item' => $this->item, 'dateDeleted' => $this->dateDeleted), static function ($value) : bool {
            return $value !== null;
        }));
    }
}
