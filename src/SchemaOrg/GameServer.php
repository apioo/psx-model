...
class GameServer extends Intangible implements \JsonSerializable
{
    ...
    {
        return array_merge(parent::jsonSerialize(), array_filter(array('playersOnline' => $this->playersOnline, 'serverStatus' => $this->serverStatus, 'gameServer' => $this->gameServer, 'game' => $this->game), static function ($value) : bool {
            return $value !== null;
        }));
    }
}
