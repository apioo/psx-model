...
class WarrantyPromise extends StructuredValue implements \JsonSerializable
{
    ...
    {
        return array_merge(parent::jsonSerialize(), array_filter(array('warrantyScope' => $this->warrantyScope, 'durationOfWarranty' => $this->durationOfWarranty), static function ($value) : bool {
            return $value !== null;
        }));
    }
}
