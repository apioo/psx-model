...
class ProgramMembership extends Intangible implements \JsonSerializable
{
    ...
    {
        return array_merge(parent::jsonSerialize(), array_filter(array('member' => $this->member, 'membershipNumber' => $this->membershipNumber, 'hostingOrganization' => $this->hostingOrganization, 'programName' => $this->programName), static function ($value) : bool {
            return $value !== null;
        }));
    }
}
