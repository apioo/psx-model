...
class Audience extends Intangible implements \JsonSerializable
{
    ...
    {
        return array_merge(parent::jsonSerialize(), array_filter(array('geographicArea' => $this->geographicArea, 'audienceType' => $this->audienceType), static function ($value) : bool {
            return $value !== null;
        }));
    }
}
